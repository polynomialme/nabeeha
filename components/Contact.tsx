      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm text-silk/70 mb-1">Name</label>
              <input
                id="name"
                type="text"
                required
            ...
            <div>
              <label htmlFor="sender-email" className="block text-sm text-silk/70 mb-1">Email</label>
              <input
                id="sender-email"
                type="email"
                required
            ...
            <div>
              <label htmlFor="message" className="block text-sm text-silk/70 mb-1">Message</label>
              <textarea
                id="message"
                required
                rows={4}
            ...
            <button
              type="submit"
              className="flex items-center gap-2 px-6 py-3 bg-ruby rounded-lg hover:bg-ruby-light transition-colors font-medium"
            >
              <Send size={18} />
              Send Message
            </button>
